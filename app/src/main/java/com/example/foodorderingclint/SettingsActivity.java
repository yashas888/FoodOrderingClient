...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void setAnswera(){
        ...
        if(question1.equals("") && question2.equals("")){
            Toast.makeText(SettingsActivity.this, "Please answer both questions", Toast.LENGTH_SHORT).show();
        }else{
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("User").child(Prevalent.currentOnlineUser.getPhone());
            ...
            ref.child("Security Question").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(SettingsActivity.this, "Security question answered successfully", Toast.LENGTH_SHORT).show();
    ...
    private void verifyUser(){
        ...
        if(!phone.equals("")&& !answer1.equals("")&& !answer2.equals("")){
            final DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("User").child(phone);
                        ...
                        if(phone.equals(mPhone)){
                            if(dataSnapshot.hasChild("Security Question")){
                                ...
                                if(!ans1.equals(answer1)&& !ans2.equals(answer2)){
                                    Toast.makeText(SettingsActivity.this, "Incorrect Answer ", Toast.LENGTH_SHORT).show();
                                }else{
                                ...
                                Toast.makeText(SettingsActivity.this, "Check Phone Number or You have not set security question", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                    else {
                        Toast.makeText(SettingsActivity.this, "Check Phone Number", Toast.LENGTH_SHORT).show();
                    }
                }
