...
public class CustomerOrders {
    ...
    public CustomerOrders(String name, String phone, String address, String city, String state, String date, String time, String totalAmount, String pid, String orderId, String phoneOrder, String area) {
        this.name = name;
        this.phone = phone;
